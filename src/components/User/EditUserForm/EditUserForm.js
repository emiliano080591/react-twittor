    ...
    return (
        <div className="edit-user-form">
            ...
            <Form onSubmit={onSubmit}>
                ...
                <Form.Group>
                    <DatePicker placeholder="Fecha de nacimiento" locale={es} selected={new Date(formData.fechaNacimiento)} onChange={value=>setFormData({...formData,fechaNacimiento:value})}/>
                </Form.Group>
